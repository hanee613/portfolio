        ...
        <section class="home">
            <section class="ftco-section">
                <div class="container join_container">
                    <h2>회원가입</h2>
					<form action="joinok.jsp" method="POST" name="form">
						<table id="join">
							<tr>
								<td>ID :</td>
							...
							<tr>
								<td></td>
								<td>아이디는 한글, 영어, ' _ '를 이용해서 입력해주세요.</td>
							</tr>
							<tr>
								<td>PASSWORD :</td>
							...
							<tr>
								<td>E-MAIL :</td>
								<td><input type="email" name="pw" class="join_txt"
									title="email"></td>
							</tr>
							<tr>
								<td>TEL :</td>
								<td><input type="text" name="pw" class="join_txt tel"
									size="5" title="TEL"> - <input type="text" name="pw"
									class="join_txt tel" size="7" title="TEL"> - <input
									type="text" name="pw" class="join_txt tel" size="7" title="TEL">
								</td>
							</tr>
						</table>
